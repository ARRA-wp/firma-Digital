...
public class Inicio extends JFrame {
	...
	public Inicio() 
	{
		...
		/*
		JButton Bienvenida = new JButton("Créditos");
		Bienvenida.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Programa creado por Ramirez Alvarez Andres Rafael");
			}
		});
                */
                /*
                  JLabel Bienvenida = new JLabel("Firma Digital");
                Bienvenida.setBounds(116, 10, 207, 23);
